...
// tick order:
// LocalPlayer.tick() (overriden): call player.tick(), send shift key info, send input info, check if riding and send sprinting info, else send sprinting and send position
// Player.tick() (overriden): disable physics if spectator, set on ground if passenger or spectator, update underwater state, super, clamp position between \pm 2.99E7 (30m), updatePlayerPose (last thing done) ->
// LivingEntity.tick() ->
